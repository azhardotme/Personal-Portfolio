...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="{{route('visitor_home')}}"><img src="{{asset('Frontend/assets/img/logo.jpg')}}" alt="Logo" /></a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $portfolio->id;?>">
                                ...
                                <img class="img-fluid" src="{{url($portfolio->big_image)}}"/>
                            </a>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start"> Azharul Islam Copyright &copy; 2020 ,All Rights Reserved</div>
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-dark btn-social mx-2" href="{{url('https://github.com/azhardotme')}}"><i class="fab fa-github"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="{{url('https://www.facebook.com/azhardotme')}}"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="{{url('https://www.linkedin.com/in/azhardotme/')}}"><i class="fab fa-linkedin-in"></i></a>
                    </div>
